...
/**
@brief The structure is used to extract/insert  Embedded audio to and from the HANC stream of 
		Greed and Leon based cards.
*/
...
struct hanc_decode_struct
{
	...
	void * raw_hanc_pkt_data_ptr;		// This would contain the raw audio frame got from ORAC card.
	BLUE_UINT32 sizeof_hanc_pkt_data_ptr;
	BLUE_UINT32 avail_hanc_pkt_data_bytes;
...
HANCUTILS_API BLUE_UINT32 encode_hanc_frame(
					struct hanc_stream_info_struct * hanc_stream_ptr,
					void * audio_pcm_ptr,BLUE_UINT32 no_audio_ch,BLUE_UINT32 
					no_audio_samples,BLUE_UINT32 nTypeOfSample,BLUE_UINT32 emb_audio_flag);
...
*/
typedef enum blue_vanc_pkt_type_enum
{
...
BLUE_INT32  vanc_pkt_extract_for_HD(
					BLUE_UINT32 CardType,
					BLUE_UINT32 vanc_pkt_type,
					BLUE_UINT32 * src_vanc_buffer,
					BLUE_UINT32 src_vanc_buffer_size,
...
BLUE_INT32  vanc_pkt_extract_for_SD(
					BLUE_UINT32 CardType,
					BLUE_UINT32 vanc_pkt_type,
					BLUE_UINT32 * src_vanc_buffer,
					BLUE_UINT32 src_vanc_buffer_size,
