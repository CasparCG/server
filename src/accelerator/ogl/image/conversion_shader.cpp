...
#include "ogl_conversion_fragment.h"
#include "ogl_conversion_vertex.h"

namespace caspar { namespace accelerator { namespace ogl {

std::weak_ptr<shader> g_conversion_shader;
std::mutex            g_conversion_shader_mutex;

std::shared_ptr<shader> get_conversion_shader(const spl::shared_ptr<device>& ogl)
{
    std::lock_guard<std::mutex> lock(g_conversion_shader_mutex);
    auto                        existing_shader = g_conversion_shader.lock();
    ...
    g_conversion_shader = existing_shader;
