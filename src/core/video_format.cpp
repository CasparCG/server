...
const std::vector<video_format_desc> format_descs = {
    ...
    {video_format::ntsc,        2,  720,  486,  720,  540, 60000, 1001, L"NTSC",      {1602 / 2, 1601 / 2, 1602 / 2, 1601 / 2, 1602 / 2 }},
    ...
    {video_format::x1080i5994,  2, 1920, 1080, 1920, 1080, 60000, 1001, L"1080i5994", {1602 / 2, 1601 / 2, 1602 / 2, 1601 / 2, 1602 / 2 }},
