...
class subject_graph : public caspar::diagnostics::spi::graph_sink
{
  ...
  public:
    ...
    void activate() override { subject_->attach_parent(get_or_create_subject()); }
    ...
    monitor::subject& subject() { return *subject_; }
...
spl::shared_ptr<monitor::subject> get_or_create_subject()
{
    static auto diag_subject = []() {
        ...
        caspar::diagnostics::spi::register_sink_factory([=]() { return spl::make_shared<subject_graph>(); });
