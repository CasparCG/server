...
class decklink_frame_side_data_vanc_strategy : public decklink_vanc_strategy
{
  public:
    ...
    virtual void push_frame_side_data(const std::vector<core::const_frame_side_data>& side_data, bool field2) = 0;
...
class decklink_vanc
{
  ...
  public:
    ...
    void push_frame_side_data(const std::vector<core::const_frame_side_data>& side_data, bool field2);
};
