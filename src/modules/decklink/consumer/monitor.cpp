                                        ...
                                        const core::video_format_desc& channel_format)
{
    ...
    if (port_config.region.has_subregion_geometry()) {
        state["subregion/src-x"]  = port_config.region.src_x;
        state["subregion/src-y"]  = port_config.region.src_y;
        state["subregion/src-x"]  = port_config.region.dest_x;
        state["subregion/dest-y"] = port_config.region.dest_y;
        state["subregion/width"]  = port_config.region.w;
        state["subregion/height"] = port_config.region.h;
    }
