...
inline core::mutable_frame
make_frame(void*                            tag,
           core::frame_factory&             frame_factory,
           std::shared_ptr<AVFrame>         video,
           std::shared_ptr<AVFrame>         audio,
           core::color_space                color_space       = core::color_space::unknown,
           core::frame_geometry::scale_mode scale_mode        = core::frame_geometry::scale_mode::stretch,
           bool                             is_straight_alpha = false)
{
    return make_frame(
        tag, frame_factory, std::move(video), std::move(audio), nullptr, color_space, scale_mode, is_straight_alpha);
}
