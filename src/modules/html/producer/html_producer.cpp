    ...
    , public CefDisplayHandler
{
  ...
  private:
    ...
    */
    ...
    /*
     * This is where the shared textures get fed into. It is specific to the obs builds (hence the 2 suffix), so might be removed/renamed when the change is accepted upstream
     */
          ...
          if (d3d_shared_buffer_ ) {
            core::pixel_format format = core::pixel_format::invalid;
              ...
              if (format != core::pixel_format::invalid) {
                  auto frame =
                      frame_factory_->import_d3d_texture(this, d3d_shared_buffer_, true, format);
                  core::draw_frame dframe(std::move(frame));
