...
static std::string get_win_product_name()
{
	std::string result = "Unknown Windows Product Name.";
	HKEY hkey; 
	DWORD dwType, dwSize;
...
static std::string get_win_sp_version()
{
	std::string result =  "";
	HKEY hkey; 
	DWORD dwType, dwSize;
