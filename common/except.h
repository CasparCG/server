...
#define CASPAR_THROW_EXCEPTION(e) ::boost::exception_detail::throw_exception_((e << traced(boost::stacktrace::stacktrace() ), BOOST_THROW_EXCEPTION_CURRENT_FUNCTION, ::caspar::log::remove_source_prefix(__FILE__), __LINE__)
