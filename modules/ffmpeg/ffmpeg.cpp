...
#include "producer2/ffmpeg_producer2.h"
...
void init(core::module_dependencies dependencies)
{
	...
	dependencies.producer_registry->register_producer_factory(L"FFmpeg Producer", boost::bind(&ffmpeg2::create_producer, _1, _2, info_repo), describe_producer);
