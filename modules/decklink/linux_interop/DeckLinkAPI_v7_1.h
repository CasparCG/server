...
#define IID_IDeckLinkDisplayModeIterator_v7_1                                                                          \
    (REFIID) { 0xB2, 0x81, 0x31, 0xB6, 0x59, 0xAC, 0x48, 0x57, 0xB5, 0xAC, 0xCD, 0x75, 0xD5, 0x88, 0x3E, 0x2F }

// "AF0CD6D5-8376-435E-8433-54F9DD530AC3"
#define IID_IDeckLinkDisplayMode_v7_1                                                                                  \
    (REFIID) { 0xAF, 0x0C, 0xD6, 0xD5, 0x83, 0x76, 0x43, 0x5E, 0x84, 0x33, 0x54, 0xF9, 0xDD, 0x53, 0x0A, 0xC3 }

// "EBD01AFA-E4B0-49C6-A01D-EDB9D1B55FD9"
#define IID_IDeckLinkVideoOutputCallback_v7_1                                                                          \
    (REFIID) { 0xEB, 0xD0, 0x1A, 0xFA, 0xE4, 0xB0, 0x49, 0xC6, 0xA0, 0x1D, 0xED, 0xB9, 0xD1, 0xB5, 0x5F, 0xD9 }

// "7F94F328-5ED4-4E9F-9729-76A86BDC99CC"
#define IID_IDeckLinkInputCallback_v7_1                                                                                \
    (REFIID) { 0x7F, 0x94, 0xF3, 0x28, 0x5E, 0xD4, 0x4E, 0x9F, 0x97, 0x29, 0x76, 0xA8, 0x6B, 0xDC, 0x99, 0xCC }

// "AE5B3E9B-4E1E-4535-B6E8-480FF52F6CE5"
#define IID_IDeckLinkOutput_v7_1                                                                                       \
    (REFIID) { 0xAE, 0x5B, 0x3E, 0x9B, 0x4E, 0x1E, 0x45, 0x35, 0xB6, 0xE8, 0x48, 0x0F, 0xF5, 0x2F, 0x6C, 0xE5 }

// "2B54EDEF-5B32-429F-BA11-BB990596EACD"
#define IID_IDeckLinkInput_v7_1                                                                                        \
    (REFIID) { 0x2B, 0x54, 0xED, 0xEF, 0x5B, 0x32, 0x42, 0x9F, 0xBA, 0x11, 0xBB, 0x99, 0x05, 0x96, 0xEA, 0xCD }

// "333F3A10-8C2D-43CF-B79D-46560FEEA1CE"
#define IID_IDeckLinkVideoFrame_v7_1                                                                                   \
    (REFIID) { 0x33, 0x3F, 0x3A, 0x10, 0x8C, 0x2D, 0x43, 0xCF, 0xB7, 0x9D, 0x46, 0x56, 0x0F, 0xEE, 0xA1, 0xCE }

// "C8B41D95-8848-40EE-9B37-6E3417FB114B"
#define IID_IDeckLinkVideoInputFrame_v7_1                                                                              \
    (REFIID) { 0xC8, 0xB4, 0x1D, 0x95, 0x88, 0x48, 0x40, 0xEE, 0x9B, 0x37, 0x6E, 0x34, 0x17, 0xFB, 0x11, 0x4B }

// "C86DE4F6-A29F-42E3-AB3A-1363E29F0788"
#define IID_IDeckLinkAudioInputPacket_v7_1                                                                             \
    (REFIID) { 0xC8, 0x6D, 0xE4, 0xF6, 0xA2, 0x9F, 0x42, 0xE3, 0xAB, 0x3A, 0x13, 0x63, 0xE2, 0x9F, 0x07, 0x88 }
...
{
  public:
    virtual HRESULT STDMETHODCALLTYPE ScheduledFrameCompleted(IDeckLinkVideoFrame_v7_1*      completedFrame,
...
{
  public:
    virtual HRESULT STDMETHODCALLTYPE VideoInputFrameArrived(IDeckLinkVideoInputFrame_v7_1*  videoFrame,
...
class IDeckLinkOutput_v7_1 : public IUnknown
{
  public:
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateVideoFrame(int32_t                    width,
                                                       int32_t                    height,
                                                       int32_t                    rowBytes,
                                                       BMDPixelFormat             pixelFormat,
                                                       BMDFrameFlags              flags,
    ...
    virtual HRESULT                   STDMETHODCALLTYPE
                                      SetScheduledFrameCompletionCallback(IDeckLinkVideoOutputCallback_v7_1* theCallback) = 0;
    ...
    // Output control
    virtual HRESULT STDMETHODCALLTYPE StartScheduledPlayback(BMDTimeValue playbackStartTime,
                                                             BMDTimeScale timeScale,
...
{
  public:
    virtual HRESULT STDMETHODCALLTYPE GetFrameTime(BMDTimeValue* frameTime,
