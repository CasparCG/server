...
class IDeckLinkOutput : public IUnknown
{
  public:
    ...
    virtual HRESULT GetFrameCompletionReferenceTimestamp(/* in */ IDeckLinkVideoFrame* theFrame,
...
class IDeckLinkMutableVideoFrame : public IDeckLinkVideoFrame
{
  public:
    ...
    virtual HRESULT SetTimecodeFromComponents(/* in */ BMDTimecodeFormat format,
                                              /* in */ uint8_t           hours,
                                              /* in */ uint8_t           minutes,
                                              /* in */ uint8_t           seconds,
                                              /* in */ uint8_t           frames,
