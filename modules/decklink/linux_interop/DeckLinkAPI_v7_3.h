...
#define IID_IDeckLinkInputCallback_v7_3 /* FD6F311D-4D00-444B-9ED4-1F25B5730AD0 */                                     \
    (REFIID) { 0xFD, 0x6F, 0x31, 0x1D, 0x4D, 0x00, 0x44, 0x4B, 0x9E, 0xD4, 0x1F, 0x25, 0xB5, 0x73, 0x0A, 0xD0 }
#define IID_IDeckLinkOutput_v7_3 /* 271C65E3-C323-4344-A30F-D908BCB20AA3 */                                            \
    (REFIID) { 0x27, 0x1C, 0x65, 0xE3, 0xC3, 0x23, 0x43, 0x44, 0xA3, 0x0F, 0xD9, 0x08, 0xBC, 0xB2, 0x0A, 0xA3 }
#define IID_IDeckLinkInput_v7_3 /* 4973F012-9925-458C-871C-18774CDBBECB */                                             \
    (REFIID) { 0x49, 0x73, 0xF0, 0x12, 0x99, 0x25, 0x45, 0x8C, 0x87, 0x1C, 0x18, 0x77, 0x4C, 0xDB, 0xBE, 0xCB }
#define IID_IDeckLinkVideoInputFrame_v7_3 /* CF317790-2894-11DE-8C30-0800200C9A66 */                                   \
    (REFIID) { 0xCF, 0x31, 0x77, 0x90, 0x28, 0x94, 0x11, 0xDE, 0x8C, 0x30, 0x08, 0x00, 0x20, 0x0C, 0x9A, 0x66 }
...
{
  public:
    virtual HRESULT DoesSupportVideoMode(BMDDisplayMode                   displayMode,
    ...
    virtual HRESULT CreateVideoFrame(int32_t                                     width,
                                     int32_t                                     height,
                                     int32_t                                     rowBytes,
                                     BMDPixelFormat                              pixelFormat,
                                     BMDFrameFlags                               flags,
                                     /* out */ IDeckLinkMutableVideoFrame_v7_6** outFrame)              = 0;
    virtual HRESULT CreateAncillaryData(BMDPixelFormat                           pixelFormat,
    ...
    virtual HRESULT EnableAudioOutput(BMDAudioSampleRate       sampleRate,
    ...
    virtual HRESULT
                    StartScheduledPlayback(BMDTimeValue playbackStartTime, BMDTimeScale timeScale, double playbackSpeed) = 0;
    virtual HRESULT StopScheduledPlayback(BMDTimeValue            stopPlaybackAtTime,
                                          /* out */ BMDTimeValue* actualStopTime,
                                          BMDTimeScale            timeScale)                                     = 0;
    virtual HRESULT IsScheduledPlaybackRunning(/* out */ bool* active)                                = 0;
    virtual HRESULT GetHardwareReferenceClock(BMDTimeScale            desiredTimeScale,
...
class IDeckLinkInputCallback_v7_3 : public IUnknown
{
  public:
    ...
    virtual HRESULT VideoInputFrameArrived(/* in */ IDeckLinkVideoInputFrame_v7_3* videoFrame,
...
class IDeckLinkInput_v7_3 : public IUnknown
{
  public:
    ...
    virtual HRESULT
                    EnableVideoInput(BMDDisplayMode displayMode, BMDPixelFormat pixelFormat, BMDVideoInputFlags flags) = 0;
    ...
    virtual HRESULT
                    EnableAudioInput(BMDAudioSampleRate sampleRate, BMDAudioSampleType sampleType, uint32_t channelCount) = 0;
