...
class IDeckLinkMutableVideoFrame_v7_6 : public IDeckLinkVideoFrame_v7_6
{
  public:
    ...
    virtual HRESULT
                    SetTimecodeFromComponents(BMDTimecodeFormat format, uint8_t hours, uint8_t minutes, uint8_t seconds, uint8_t frames, BMDTimecodeFlags flags) = 0;
...
class IDeckLinkConfiguration_v7_6 : public IUnknown
{
  public:
    ...
    virtual HRESULT
                    SetVancSourceLineMapping(/* in */ uint32_t activeLine1VANCsource, /* in */ uint32_t activeLine2VANCsource, /* in */ uint32_t activeLine3VANCsource) = 0;
