...
public:
	...
	void clear()
	{
		...
		flash_producer_->initialize(safe_ptr<core::frame_factory>(frame_factory_));
	}
	...
	safe_ptr<core::draw_frame> receive()
	{
		return flash_producer_->receive();
	}
		
	void initialize(const safe_ptr<core::frame_factory>& frame_factory)
	{
...
safe_ptr<core::draw_frame> cg_producer::receive(){return impl_->receive();}
...
void cg_producer::initialize(const safe_ptr<core::frame_factory>& frame_factory){impl_->initialize(frame_factory);}
