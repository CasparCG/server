...
inline s32_x operator>>(const s32_x& lhs, int count) { return s32_x(lhs) >>= count; }

inline s32_x operator<<(const s32_x& lhs, int count) { return s32_x(lhs) <<= count; }

inline s32_x operator|(const s32_x& lhs, const s32_x& rhs) { return s32_x(lhs) |= rhs; }
...
s16_x s16_x::unpack_low(const s8_x& lhs, const s8_x& rhs) { return _mm_unpacklo_epi8(rhs.value_, lhs.value_); }

s16_x s16_x::unpack_high(const s8_x& lhs, const s8_x& rhs) { return _mm_unpackhi_epi8(rhs.value_, lhs.value_); }
...
s16_x s16_x::multiply_low(const s16_x& lhs, const s16_x& rhs) { return _mm_mullo_epi16(lhs.value_, rhs.value_); }

s16_x s16_x::multiply_high(const s16_x& lhs, const s16_x& rhs) { return _mm_mulhi_epi16(lhs.value_, rhs.value_); }

s16_x s16_x::unpack_low(const s16_x& lhs, const s16_x& rhs) { return _mm_unpacklo_epi16(lhs.value_, rhs.value_); }

s16_x s16_x::unpack_high(const s16_x& lhs, const s16_x& rhs) { return _mm_unpackhi_epi16(lhs.value_, rhs.value_); }

s16_x s16_x::and_not(const s16_x& lhs, const s16_x& rhs) { return _mm_andnot_si128(lhs.value_, rhs.value_); }

s16_x s16_x::max(const s16_x& lhs, const s16_x& rhs) { return _mm_max_epi16(lhs.value_, rhs.value_); }

s16_x s16_x::min(const s16_x& lhs, const s16_x& rhs) { return _mm_min_epi16(lhs.value_, rhs.value_); }

inline s16_x operator+(const s16_x& lhs, const s16_x& rhs) { return s16_x(lhs) += rhs; }

inline s16_x operator-(const s16_x& lhs, const s16_x& rhs) { return s16_x(lhs) -= rhs; }

inline s16_x operator>>(const s16_x& lhs, int count) { return s16_x(lhs) >>= count; }
...
s8_x s8_x::upack(const s16_x& lhs, const s16_x& rhs) { return _mm_packus_epi16(lhs.value_, rhs.value_); }

s16_x s8_x::multiply_add(const u8_x& lhs, const s8_x& rhs) { return _mm_maddubs_epi16(lhs.value_, rhs.value_); }

s8_x s8_x::max(const s8_x& lhs, const s8_x& rhs) { return _mm_max_epi8(lhs.value_, rhs.value_); }

s8_x s8_x::min(const s8_x& lhs, const s8_x& rhs) { return _mm_min_epi8(lhs.value_, rhs.value_); }

inline s8_x operator+(const s8_x& lhs, const s8_x& rhs) { return s8_x(lhs) += rhs; }
...
u8_x u8_x::max(const u8_x& lhs, const u8_x& rhs) { return _mm_max_epu8(lhs.value_, rhs.value_); }

u8_x u8_x::min(const u8_x& lhs, const u8_x& rhs) { return _mm_min_epu8(lhs.value_, rhs.value_); }
...
}}}} // namespace caspar::accelerator::cpu::xmm
