...
{	
	...
	auto s_levels = source.levels;
	auto d_levels = dest.levels;

	result.levels.max_input = do_tween(time, s_levels.max_input, d_levels.max_input, duration, tweener);
	result.levels.min_input = do_tween(time, s_levels.min_input, d_levels.min_input, duration, tweener);	
	result.levels.max_output = do_tween(time, s_levels.max_output, d_levels.max_output, duration, tweener);
	result.levels.min_output = do_tween(time, s_levels.min_output, d_levels.min_output, duration, tweener);
	result.levels.gamma = do_tween(time, s_levels.gamma, d_levels.gamma, duration, tweener);
