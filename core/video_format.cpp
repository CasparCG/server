...
#define DEFINE_VIDEOFORMATDESC(w, h, m, f, s, fmt, t, d) { (fmt), (w), (h), (m), (m == video_mode::progressive ? f : f/2.0), (1.0/(m == video_mode::progressive ? f : f/2.0)), ((w)*(h)*4), (s), (t), (d) }

namespace caspar { namespace core {
	
const video_format_desc format_descs[video_format::invalid] =  
{									   
	DEFINE_VIDEOFORMATDESC(720,  576,  video_mode::upper,			50,			TEXT("PAL"),		video_format::pal		, 25, 1), 
	...
	DEFINE_VIDEOFORMATDESC(1280, 720,  video_mode::progressive,		25,			TEXT("720p2500"),	video_format::x720p2500	, 25, 1), 
	DEFINE_VIDEOFORMATDESC(1280, 720,  video_mode::progressive,		50,			TEXT("720p5000"),	video_format::x720p5000	, 50, 1), 
	...
	DEFINE_VIDEOFORMATDESC(1920, 1080, video_mode::upper,			50,			TEXT("1080i5000"),	video_format::x1080i5000, 25, 1),
	...
	DEFINE_VIDEOFORMATDESC(1920, 1080, video_mode::progressive,		25,			TEXT("1080p2500"),	video_format::x1080p2500, 25, 1),
	...
	DEFINE_VIDEOFORMATDESC(0,		0, video_mode::invalid,			-1,			TEXT("invalid"),	video_format::invalid,	  0, 0)
};
