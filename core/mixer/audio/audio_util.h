...
{	
	...
	auto output8	 = std::vector<int8_t, tbb::cache_aligned_allocator<int8_t>>(size*3);
	
	for(int n = 0; n < size; ++n)
	{
		output8[n*3+0] = input8[n*4+1];
		output8[n*3+1] = input8[n*4+2];
		output8[n*3+2] = input8[n*4+3];
	}
