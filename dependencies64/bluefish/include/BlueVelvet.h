...
public:
	...
	virtual int count_video_mode(int DeviceId = 0) = 0;

	//	4.2.21	enum_video_mode
	virtual EVideoMode enum_video_mode(int Index, int DeviceId = 0) = 0;

	//	4.2.22	count_memory_format
	virtual int count_memory_format(int DeviceId = 0) = 0;

	//	4.2.23	enum_memory_format
	virtual EMemoryFormat enum_memory_format(int Index, int DeviceId = 0) = 0;

	//	4.2.24	count_update_method
	virtual int count_update_method(int	DeviceId = 0) = 0;

	//	4.2.25	enum_update_method
	virtual EUpdateMethod enum_update_method(int Index, int DeviceId = 0) = 0;
